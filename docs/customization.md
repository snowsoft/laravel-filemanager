...
## Views
Copy views to `resources/views/vendor/snowsoft/laravel-filemanager/` :
...
1. Copy `vendor/snowsoft/laravel-filemanager/src/lang/en` to `/resources/lang/vendor/laravel-filemanager/<YOUR LANGUAGE>/lfm.php`.
