## Note
Check `vendor/snowsoft/laravel-filemanager/src/views/demo.blade.php`, which already integrated all options from below.
...
* Sample 2 - With JQuery Selector:
  ...
  <script src="/vendor/snowsoft/laravel-ckeditor/adapters/jquery.js"></script>
  <script>
