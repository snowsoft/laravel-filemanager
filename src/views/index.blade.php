...
<head>
  ...
  <style>{!! \File::get(base_path('vendor/snowsoft/laravel-filemanager/public/css/lfm.css')) !!}</style>
...
<body>
  ...
  <script>{!! \File::get(base_path('vendor/snowsoft/laravel-filemanager/public/js/script.js')) !!}</script>
